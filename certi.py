    ...
    try:
        with open(FILE_CODE, "r", encoding="UTF-8") as read_code:
            ...
            if allow:
                ...
                message = ":: Vas por buen camino, sin embargo no estas cumpliendo con el criterio de evaluacion ::\n:: NO ESTAS USANDO ::"
            ...
            if deny:
                message = ":: Todo bien, pero no puedes utilizar las siguientes sentencias ::\n:: ESTAS USANDO ::"
